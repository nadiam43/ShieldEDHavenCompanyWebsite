...
import CTABanner from '../components/CTABanner'; // adjust path if needed
...
// import catherineImg from '../assets/catherine.jpeg';
...
const interns = [
  ...
  // Marketing Interns
//   { name: 'Catherine Burkett', title: 'Marketing Intern', bio: 'Catherine brings passion for marketing and creativity to support ShieldED Haven’s mission and campaigns.', img: catherineImg },
    ...
    <div className="min-h-screen bg-white pt-20">
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Cards appear individually as you scroll */}
          ...
          <div className="mt-20">
            ...
            {/* Whole carousel pops in on scroll */}
            <motion.div
              initial={{ opacity: 0, y: 60 }}
              whileInView={{ opacity: 1, y: 0 }}
